      ...
      {isOwner ? (
        ...
        >
          <div className="flex flex-col w-auto mr-4 ">
            <div className="w-auto bg-green-400 px-4 py-3 rounded-tl-xl rounded-br-xl rounded-bl-xl mb-2">
              <p className="font-sans font-light text-white">{item?.message}</p>
            </div>
        ...
        >
          ...
          <div className="flex flex-col w-auto ml-4">
            <div className="w-auto bg-white px-4 py-3 rounded-tr-xl rounded-br-xl rounded-bl-xl mb-2">
